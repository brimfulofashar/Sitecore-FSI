            ...
            <div className="row">
              ...
              <div className="col-12 d-flex gap-2 align-items-center justify-content-end mb-5">
                ...
                <FacebookShareButton url={currentUrl}>
                  <FacebookIcon round size={48} bgStyle={{ fill: 'var(--bg-saturated)' }} />
                </FacebookShareButton>
                <TwitterShareButton url={currentUrl}>
                  <TwitterIcon round size={48} bgStyle={{ fill: 'var(--bg-saturated)' }} />
                </TwitterShareButton>
                <LinkedinShareButton url={currentUrl}>
                  <LinkedinIcon round size={48} bgStyle={{ fill: 'var(--bg-saturated)' }} />
                </LinkedinShareButton>
              </div>
            </div>
          </div>

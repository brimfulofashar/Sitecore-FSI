...
const Layout = ({ page }: LayoutProps): JSX.Element => {
  ...
  // This rendering host is the Texas Mutual vertical; keep brand tokens independent of XM “site name” in env.
  const contextSiteClass = 'site-texasmutual';
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Texas Mutual workers’ compensation insurance – Sitecore demo experience."
        ></meta>
      </Head>

            ...
            <React.Fragment key={item.url}>
              ...
              >
                ...
                <div className="col-lg-8">
                  <span className="newsroom-tag">{t('Newsroom') || 'Newsroom'}</span>
                  <h3 className="fs-4">
                  ...
                  <div className="d-flex flex-wrap gap-3 justify-content-between align-items-center">
                    <Link href={item.url} className="button button-main">
    ...
    >
      <div className="container">
        <div className="row align-items-center mb-4">
          <div className="col">
            <div className="title display-6">{t('Latest News') || 'Latest News'}</div>
          </div>
        ...
        <div className="row row-gap-4">
          {newsItems?.map((item) => (
            <div className="col-md-6 col-lg" key={item.url}>
              <Link href={item.url} className="wrapper-link">
                <NextImage field={item.fields.Thumbnail} width={400} height={300} />
                <span className="newsroom-tag">{t('Newsroom') || 'Newsroom'}</span>

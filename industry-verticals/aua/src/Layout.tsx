...
const Layout = ({ page }: LayoutProps): JSX.Element => {
  ...
  return (
    <>
      ...
      <Head>
        <title>{fields?.Title?.value?.toString() || 'American Urological Association'}</title>
        <link rel="icon" href={`/favicon.ico`} />
        <meta
          name="description"
          content="American Urological Association — advancing urology through education, research, and advocacy."
        ></meta>
      </Head>
